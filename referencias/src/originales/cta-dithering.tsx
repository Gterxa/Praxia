// Tal cual lo entregó el proveedor del componente. Usa clases de shadcn
// (bg-card, text-muted-foreground, bg-primary), que acá existen porque
// src/estilos.css define esos tokens.
