...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="90" y="462" font-family="Helvetica, Arial, sans-serif" font-size="31" fill="#5C6672">con inteligencia artificial. Diagnóstico gratuito.</text>
  <rect x="90" y="524" width="330" height="4" fill="#E2E0DC"/>
  <text x="90" y="574" font-family="Helvetica, Arial, sans-serif" font-size="26" font-weight="600" fill="#9A4A2A">Perú · Lima y provincias</text>
</svg>`;
